...
class PcntBootstrapController extends Controller
{
/**
...
if($model->save())
$this->redirect(array('view','id'=>$model->pcnt_id));
}
...
{
$dataProvider=new CActiveDataProvider('PcntContactType');
...
{
$model=PcntContactType::model()->findByPk($id);
if($model===null)
